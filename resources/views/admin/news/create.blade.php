...
<div class="card">
	<div class="card-header page-header">	
		<h2 class="page-title"></span>Create new news </h2>
...
<div class="card">
	...
	<div class="card-body">
        <form method="post" action="{{route('asdo.news.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="heading" class="form-label">News heading</label>
                <textarea class="form-control" name="heading" id="heading" aria-describedby="heading">{{old('heading')}}</textarea>
                @error('heading')
            ...
            <div class="mb-3">
                ...
                <div class="custom-file">
                    ...
                    <label class="custom-file-label" id="image-label" for="image">Choose file...</label>
                </div>
                @error('image')
                    <div class="text-danger">
                    <strong>{{$message}}</strong>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="publishing_date" class="form-control" id="publishing-date" value="{{old('publishing_date')}}">
            ...
            <div class="mb-2">
                ...
                <input type="number" name="lifetime" class="form-control" id="lifetime">
                @error('lifetime')
                    <div class="text-danger">
                    <strong>{{$message}}</strong>
                    </div>
