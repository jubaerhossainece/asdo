...
<div class="card">
	<div class="card-header header">
		<h2 class="card-title">Program Management Panel</h2>
							...
							@foreach($projects as $key => $project)
								<tr>
									...
									<td class="text-center">
										...
										<a href="{{route('asdo.projects.edit', $project->id)}}" class="btn btn-primary btn-sm" data-tooltip="tooltip" data-placement="bottom" title="Edit program detail">
											<i class="fas fa-edit"></i>
										</a>
										@endcan
										@can('app.projects.show')
				    				<a href="{{route('asdo.projects.show', $project->id)}}" class="btn btn-secondary btn-sm" data-tooltip="tooltip" data-placement="bottom" title="show program information" >
				    					<i class="fas fa-eye"></i>
				    				</a>
				    				@endcan
				    				@can('app.projects.destroy')
										<button data-toggle="modal" data-tooltip="tooltip" data-target="#alertModal" data-id = "{{$project->id}}" data-placement="bottom" title="Delete program Detail" onclick="deleteData({{$project->id}})" class="btn btn-danger btn-sm">
